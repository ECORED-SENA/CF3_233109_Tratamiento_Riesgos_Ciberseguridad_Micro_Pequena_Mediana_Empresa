  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1(data-aos="fade-right") Endurecimiento del servicio
          ...
          .row.justify-content-center
            .col-auto
              figure(data-aos="fade-down-right")
                img.img-t.m-auto(src='@/assets/curso/tema3/img02.svg', alt='')
    ...
    .row
      .col-lg-10
        .row.justify-content-lg-center.mb-5(data-aos="fade-down-right")
          .col-lg-4.mb-4.mb-lg-0
            figure
              img.img-t.m-auto.img_position(src='@/assets/curso/tema3/img28.svg')
          .col-lg-8
            .bg_34-1.p-4.ps-5
              .row.justify-content-center
                .col-xxl-9.col-xl-9.col-lg-9
                  ul.fa-ul2.lista-ul--color.ms-0.ms-lg-5.ps-lg-3.ps-xl-0
                    li
                      i.fas.fa-check-circle
                      span Ejecute siempre cualquier aplicación como usuario restringido en un entorno restringido.
                    li
                      i.fas.fa-check-circle
                      span Mantenga las aplicaciones y el <em>firmware</em> actualizados.
                    li
                      i.fas.fa-check-circle
    ...
    .row
      .col-lg-10
        .row.justify-content-center.mb-5(data-aos="fade-down-right")
          .col-lg-4.mb-4.mb-lg-0
            figure
              img.img-t.m-auto.img_position(src='@/assets/curso/tema3/img35.svg')
          .col-lg-8
            .bg_34-1.p-4.ps-5
              .row.justify-content-center
                .col-xxl-9.col-xl-9.col-lg-8
                  ...
                  ul.fa-ul2.lista-ul--color.ms-0.ms-lg-5.ps-lg-3.ps-xl-0
                    li
                      i.fas.fa-check-circle
                      span Utilizar privilegios y funciones granulares para los usuarios.
                    li
                      i.fas.fa-check-circle
                      span Adhiérase a las mejores prácticas de necesidad de conocimiento y de mínimo privilegio cuando configure cuentas o funciones de usuario.
                    li
                      i.fas.fa-check-circle
    ...
    p.text-bold.mb-5 Los ataques más comunes asociados a las vulnerabilidades en la gestión de la configuración son los siguientes:

    .bg_47.p-4.mb-5
      .row.justify-content-center
        .col-lg-4.mb-4.mb-lg-0.align-self-center(data-aos="fade-right")
          figure(data-aos="fade-down-right")
            img.img-t.m-auto(src='@/assets/curso/tema3/img38.svg', alt='')
        .col-lg-6.align-self-center(data-aos="fade-left")
          ul.fa-ul2.lista-ul--color
            li
              i.fas.fa-check-circle
              span Defectos en el #[em software] del servidor o configuraciones erróneas que permiten el listado de directorios y los ataques de cruce de directorios.
            li
              i.fas.fa-check-circle
              span Archivos innecesarios por defecto, de copia de seguridad o de muestra, incluyendo scripts, aplicaciones, archivos de configuración y páginas web.
            li
              i.fas.fa-check-circle
              span Permisos inadecuados de archivos y directorios.
            li
              i.fas.fa-check-circle
              span Servicios innecesarios habilitados, incluyendo la gestión de contenidos y la administración remota.
            li
              i.fas.fa-check-circle
              span Cuentas por defecto con sus contraseñas por defecto.
            li
              i.fas.fa-check-circle
              span Funciones administrativas o de depuración habilitadas o accesibles.
            li
              i.fas.fa-check-circle
              span Mensajes de error demasiado informativos (más detalles en la sección de gestión de errores).
            li
              i.fas.fa-check-circle
            ...
            li
              i.fas.fa-check-circle
              span Autenticación incorrecta con sistemas externos.
        ...
        .row.justify-content-center.align-items-center.mb-5
          ...
          .col-md-6.col-lg-4.mb-4.mb-lg-0(data-aos="fade-up")
            .tarjeta-avatar-b.m_tarslyder3
              ...
              .tarjeta.tarjeta--azul.flex-center-text
                .p-4
                  p.text-center Repetición de sesión.
          .col-md-6.col-lg-4(data-aos="fade-left")
            .tarjeta-avatar-b.m_tarslyder3
              ...
              .tarjeta.tarjeta--azul.flex-center-text
                .p-4
                  p.m-0.text-center Ataques de intermediario <em>(Man-in-the-middle)</em>.
    ...
    .row
      .col-lg-10
        .row.justify-content-center.mb-5(data-aos="fade-down-right")
          .col-lg-4.mb-4.mb-lg-0
            figure
              img.img-t.m-auto.img_position(src='@/assets/curso/tema3/img43.svg')
          .col-lg-8
            .bg_34-1.p-4.ps-5
              .row.justify-content-center
                .col-lg-8.pt-4
