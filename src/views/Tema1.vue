  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-8(data-aos="fade-left")
        ...
        p El proceso de alquimia está a cargo de un puñado de empleados de confianza bien evaluados y todos los sistemas de control y supervisión del SCI (Sistema de Control Interno) están conectados entre sí a través de una red Ethernet con una solución de acceso remoto que permite la interacción a distancia. El rey tiene acceso a todo el ICS (Sistema de Control Interno) desde su trono, por lo que puede vigilar la rapidez con la que se enriquece e interactuar con los sistemas siempre que lo necesite.
